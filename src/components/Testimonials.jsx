export default function Testimonials() {
    return (
        <section className="container mx-auto px-6 py-16 md:px-0 lg:py-28">
            ...
            <div className="w-full flex flex-col flex-wrap justify-center items-center gap-14 md:flex-row">

                <div className="max-w-96 flex flex-col justify-center items-center gap-7">
